                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group text-dark">
                            ...
                            <input type="text" class="form-control" placeholder="Email" value="<?php echo $user['user_email'] ?>">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group text-dark">
                            <label for="email"><strong>Username</strong></label>
                            <input type="text" class="form-control" placeholder="Username" value="<?php echo $user['username'] ?>">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group text-dark">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group text-dark">
                            ...
                            <input type="text" class="form-control" placeholder="Phone Number" value="<?php echo $user['user_cpnumber'] ?>">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group text-dark">
                            <label for="address"><strong>Address</strong></label>
                            <input type="text" class="form-control" placeholder="Address" value="<?php echo $user['user_address'] ?>">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">

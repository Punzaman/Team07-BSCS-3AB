...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url() ?>css/images/PayPark Logo.png">
        ...
        <div class="content">
            ...
            <div class="general">
                <div class="acctProf">
                    ...
                    <a href="<?php echo base_url() . "users/update" ?>"><button type="button" id="confirmCode" class="btn btn-primary btn-sm mt-4 ms-auto"> <strong>Edit Account Profile</strong> </button></a>
                </div>

                <div class="acctAttri mx-auto">
                    <div class="attribute pt-3 px-4">
                        <p>Username<br> <span>
                                <?php
                    ...
                    <hr>
                    <div class="attribute px-4">
                        <p>E-mail Address<br> <span>
                                <?php

        ...
        <div class="content">
            ...
            <div class="generalDeact2">
                <div class="deactivateCont pt-4 px-2 mx-auto">
                    <p>Confirm Log out.</p>
                    <p class="notice">Are you sure, you want to log out?</p>
                </div>
            </div>
            <div class="confirmation mx-auto">
                <a href="<?php echo base_url() . "users/logoutpageconfirm" ?>"><button type="button" id="confirmCode1" class="btn btn-primary btn-sm mx-5 mt-4 ms-auto"> <strong>Confirm</strong> </button></a>

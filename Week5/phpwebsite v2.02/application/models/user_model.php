...
class User_model extends CI_Model {
    ...
    public function createUser($data){
		...
		else if($this->emailExist($data['email'])){
			echo "emailExist";
			return;
		}
	...
	public function pwdMatch($user_pwd, $user_pwdrepeat){
		if($user_pwd !== $user_pwdrepeat){
			return true;
		}
		else{
			return false;
	...
	public function loginUser($username, $user_pwd){
		$this->db->where('username', $username)

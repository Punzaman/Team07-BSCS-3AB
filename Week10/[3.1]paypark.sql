...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2022 at 11:19 AM
...
INSERT INTO `reservation` (`reserveId`, `reserveDate`, `reservePark`, `reserveVehicle`, `reserveLocation`, `reserveUser`) VALUES
(1, '0000-00-00', '', '', '', '1'),
(2, '0000-00-00', '', '', '', '1'),
(3, '0000-00-00', '', '', '', '1'),
(4, '0000-00-00', '', '', '', '1'),
...
(21, '2022-01-10', '22:00', '18', 'location1', '4'),
(22, '2022-01-15', '20:00', '18', 'MANILA', '4');
...
('Active', 4, 'q', 'q', 'q@gmail.com', 'q', '7694f4a66316e53c8cdd9d9954bd611d', '');
...
--
ALTER TABLE `reservation`
  MODIFY `reserveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
